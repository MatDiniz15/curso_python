...
Multiplicar o resultado amterior por 10 
363 * 10 = 3630
...
"""
# cpf = '36440847007' esse CPF gera o primeiro digito com 10 (0)
...
cpf_enviado_usuario = re.sub(
    r'[^0-9]', #aqui vai substituir tudo que não for numero
    '',
    entrada
)
...
if cpf_enviado_usuario == cpf_gerado_pelo_calculo:
    print(f'{cpf_enviado_usuario} CPF valido')
else:
    print('CPF inválido')